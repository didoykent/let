...
var connected = false
  ...
  if(clients.length<3){
                ...
                if(!connected){
                  ...
                  io.to(latestmessage.friend['previous_conn_id']).emit('messageNotification',{bonusdata: latestmessage.bonusdata})
                    io.to(latestmessage.friend['current_conn_id']).emit('messageNotification', {bonusdata: latestmessage.bonusdata})
                }
